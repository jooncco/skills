...
Markdown file under `~/.copilot/skills/reverse-engineering/knowledge/developer/` (`code-analysis-guide.md`,
`re-artifacts.md`) and `~/.copilot/skills/reverse-engineering/knowledge/shared/` if present. The dispatch
