...
Markdown file under `.agents/skills/reverse-engineering/knowledge/developer/` (`code-analysis-guide.md`,
`re-artifacts.md`) and `.agents/skills/reverse-engineering/knowledge/shared/` if present. The dispatch
