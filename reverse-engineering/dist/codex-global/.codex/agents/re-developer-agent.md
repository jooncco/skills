...
Markdown file under `~/.codex/skills/reverse-engineering/knowledge/developer/` (`code-analysis-guide.md`,
`re-artifacts.md`) and `~/.codex/skills/reverse-engineering/knowledge/shared/` if present. The dispatch
