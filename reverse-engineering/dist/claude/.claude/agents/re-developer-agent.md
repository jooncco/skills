...
Markdown file under `.claude/skills/reverse-engineering/knowledge/developer/` (`code-analysis-guide.md`,
`re-artifacts.md`) and `.claude/skills/reverse-engineering/knowledge/shared/` if present. The dispatch
