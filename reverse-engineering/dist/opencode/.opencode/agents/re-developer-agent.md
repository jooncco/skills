...
Markdown file under `.opencode/skills/reverse-engineering/knowledge/developer/` (`code-analysis-guide.md`,
`re-artifacts.md`) and `.opencode/skills/reverse-engineering/knowledge/shared/` if present. The dispatch
