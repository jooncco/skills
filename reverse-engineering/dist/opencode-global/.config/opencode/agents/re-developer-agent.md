...
Markdown file under `~/.config/opencode/skills/reverse-engineering/knowledge/developer/` (`code-analysis-guide.md`,
`re-artifacts.md`) and `~/.config/opencode/skills/reverse-engineering/knowledge/shared/` if present. The dispatch
