...
Markdown file under `.github/skills/reverse-engineering/knowledge/developer/` (`code-analysis-guide.md`,
`re-artifacts.md`) and `.github/skills/reverse-engineering/knowledge/shared/` if present. The dispatch
