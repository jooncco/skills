...
Markdown file under `.github/skills/reverse-engineering/knowledge/architect/` (`re-synthesis-checklist.md`,
`architecture-patterns.md`) AND `.github/skills/reverse-engineering/knowledge/developer/re-artifacts.md`
(the artifact templates and the Scope of Analysis rules you must follow), plus
`.github/skills/reverse-engineering/knowledge/shared/` if present. Read the `.github/skills/reverse-engineering/templates/`
...
- NEVER write into `codekb/<repo>/` directly. Publication goes through
  `bun .github/skills/reverse-engineering/scripts/codekb.ts publish ...` with the snapshot values from
