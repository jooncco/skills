# reverse-engineering — GitHub Copilot distribution
...
- `.github/skills/reverse-engineering/` — the skill (SKILL.md, harness annexes, knowledge, templates, scripts)
- `.github/agents/re-developer-agent.*`, `re-architect-agent.*` — the two pipeline personas
...
Verify: `bun .github/skills/reverse-engineering/scripts/codekb.ts help`
