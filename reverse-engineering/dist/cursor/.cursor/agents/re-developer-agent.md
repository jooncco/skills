...
Markdown file under `.cursor/skills/reverse-engineering/knowledge/developer/` (`code-analysis-guide.md`,
`re-artifacts.md`) and `.cursor/skills/reverse-engineering/knowledge/shared/` if present. The dispatch
